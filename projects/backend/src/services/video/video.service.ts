...
import { convertToWhereCondition, normalizeString } from '~backend/utils/postgres.utils';
...
export class VideoService {
    ...
    async search(
        ...
        const where = convertToWhereCondition({ id, animeId, episode, kind, language, quality });
